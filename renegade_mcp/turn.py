...
# Move-learn and evolution flows live in move_learning.py. The legacy
# underscore-prefixed names are re-exported here so that callers in this
# module (and external consumers like use_item.py and
# tests/test_qa_bug018_move_learn_identification.py) continue to work
# unchanged. Lazy imports inside move_learning's function bodies break the
# import cycle back to this module.
from renegade_mcp.move_learning import (  # noqa: F401
    TASK_DATA_MOVE_OFF,
    TASK_DATA_SLOT_OFF,
    clear_overworld_text as _clear_overworld_move_learn_text,
    enrich_move_learn_result as _enrich_move_learn_result,
    get_move_learn_info as _get_move_learn_info,
    handle_evolution_what as _handle_evolution_what,
    is_evolution_text_on_screen as _is_evolution_text_on_screen,
    learn_move as _learn_move_flow,
    learn_move_overworld as _learn_move_overworld,
    skip_move_learn as _skip_move_learn_flow,
    skip_move_learn_overworld as _skip_move_learn_overworld,
    wait_for_evolution as _wait_for_evolution,
)
