...
- **Next**: Grind team to 25+ on Route 205 (use `backup_move` for Torment). Rematch Gardenia. After gym: Team Galactic Eterna Building. Shroomish on Route 203 wants an Oran Berry (come back later).
