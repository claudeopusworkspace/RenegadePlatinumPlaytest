...
Archived dev session log — entries from 2026-04-14 and earlier, split out from DEV_HISTORY.md on 2026-04-19 to keep the active file trim.

See DEV_HISTORY.md for 2026-04-15 onward (QA-bug-fix era).
