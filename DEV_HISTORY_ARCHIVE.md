...
Archived dev session log. Entries from 2026-04-20 and earlier, split out from DEV_HISTORY.md to keep the active file trim. Most recent archive cut: 2026-04-24 (moved sessions 18–23 of the QA-bug-fix / parallel-fleet era).

See DEV_HISTORY.md for 2026-04-21 onward.
